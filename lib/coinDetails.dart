                      ...
                      child: LineChart(LineChartData(
                          titlesData:  FlTitlesData(
                              ...
                              topTitles: AxisTitles(
                                  ...
                                  //   return SideTitleWidget(child: Text(meta.toString(), style: TextStyle(color: Colors.blue),), axisSide: AxisSide.bottom);
                                    
                                  //   // Text(value.toString(), style: TextStyle(color: Colors.blue),);
              ...
              child: Row(
               ...
               ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      fixedSize: const Size(150, 40),
                      backgroundColor: Colors.amber),
                    onPressed: (){}, child: const Text(' SELL', style: TextStyle(fontSize: 18),)),
                ],
              ),
            )
          ],
