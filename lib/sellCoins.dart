...
class _SellCoinState extends State<SellCoin> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Sell Coins', style: TextStyle(color: Colors.white, fontSize: 20),),
        actions: [
                    Padding(
                      ...
                      return const BuyCoin();
                                ...
                                }, child: Text('Buy Coins', style: TextStyle(color: Colors.amber, fontSize: 13, fontWeight: FontWeight.bold))),
                    )
              ...
              children: [
               ...
               padding: const EdgeInsets.symmetric(vertical:25.0),
                 ...
                 ElevatedButton(
                  ...
                  onPressed: (){}, child: Text('PREVIEW SELL'))
          ],
        ),
      ),
    );
